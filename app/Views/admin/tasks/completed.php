            ...
            <div class="col-12">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title mb-0">Tasks Completed</h4>
                    </div>
								...
								<?php if (!empty($tasks)): ?>
								  <?php foreach ($tasks as $i => $t): ?>
									<?php
									  ...
									  $duration = '—';
									  if (!empty($t['started_at']) && !empty($t['completed_at'])) {
										$start = new DateTime($t['started_at']);
									  ...
									  // SLA result
									  $slaLate = ($t['due_date'] && strtotime($t['completed_at']) > strtotime($t['due_date']));
									?>
									<tr>
									  <td><?= $i + 1 ?></td>

									  <td><strong><?= htmlspecialchars($t['entity_reference']) ?></strong></td>
									  ...
									  <td><?= $t['started_at'] ? date('d M Y', strtotime($t['started_at'])) : '—' ?></td>

									  <td><?= date('d M Y', strtotime($t['completed_at'])) ?></td>
									  ...
									  <td>
										<span class="badge <?= $slaLate ? 'bg-danger' : 'bg-success' ?>">
										  <?= $slaLate ? 'Late' : 'On Time' ?>
										</span>
									  </td>
									  ...
									  <td>
										<a href="<?= htmlspecialchars(\portalPath('task_view.php?id=' . $t['task_id'])) ?>"
