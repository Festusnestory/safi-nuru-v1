...
/** @var string $reassignTaskCsrf */
/** @var string $baseUrl */
$reassignEndpoint = \portalPath('config/reassign_task.php');
?>
<!DOCTYPE html>
								...
								<tbody>
									...
									<tr class="<?= $t['is_overdue'] ? 'table-warning' : '' ?>">
										...
										<td style="min-width:300px;">
											...
											<!-- Due date -->
											<div class="mb-2">
												<small class="<?= $t['is_overdue'] ? 'text-danger fw-bold' : 'text-muted' ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.reassign-agent').forEach(select => {
        select.addEventListener('change', function () {
            ...
            fetch(<?= json_encode($reassignEndpoint) ?>, {
                method: 'POST',
