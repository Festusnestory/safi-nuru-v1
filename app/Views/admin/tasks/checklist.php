<?php
/** @var array $stages */
/** @var array $stageOrder */
/** @var int $propertyId */
/** @var int $checklistAllocationId */
/** @var string $checklistCsrf */
/** @var bool $canEditChecklist */
/** @var string $baseUrl */
?>
<!DOCTYPE html>
<html dir="ltr" lang="en">
  <head>
    ...
    <!-- This Page CSS -->
    <link
      href="<?= $baseUrl ?>/assets/libs/bootstrap-table/dist/bootstrap-table.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <!-- Custom CSS -->
  ...
  <body>
    ...
    <!-- This Page JS -->
    <script src="<?= $baseUrl ?>/assets/libs/bootstrap-table/dist/bootstrap-table.min.js"></script>
    <script src="<?= $baseUrl ?>/assets/libs/bootstrap-table/dist/bootstrap-table-locale-all.min.js"></script>
    <script src="<?= $baseUrl ?>/dist/js/pages/tables/bootstrap-table.init.js"></script>
    ...
    <script>
        ...
        function prevStage() {
			...
			function toggleItem(checkbox) {
				...
				xhr.open('POST', <?= json_encode(\portalPath('config/save-checklist-item.php')) ?>, true);
