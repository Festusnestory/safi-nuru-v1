 ...
 *
 * Access control, buyer lookup, and the ownership checks below all now run
 * in App\Controllers\Admin\BuyerController::profile() before this view
 * renders. $errorMessage/$errorStatus are still surfaced here (rather than
 * short-circuited in the controller) so an invalid/unauthorized request
 * dies at the exact same point in the page - after the chrome renders,
 * before the profile content - matching the original file's output byte
 * for byte instead of skipping straight to a bare error with no chrome.
 */
/** @var string|null $errorMessage */
/** @var int|null $errorStatus */
                    ...
                    <div class="card-body">
                      <div class="profiletimeline mt-0">
                        ...
                        <div class="sl-item d-flex align-items-start">
                          <div class="sl-left">
                            <img
                              src="<?= $baseUrl ?>/assets/images/users/3.jpg"
                              alt="user"
                              class="rounded-circle"
                            />
                          </div>
                        ...
                        <div class="sl-item d-flex align-items-start">
                          <div class="sl-left">
                            <img
                              src="<?= $baseUrl ?>/assets/images/users/4.jpg"
                              alt="user"
                              class="rounded-circle"
                            />
                          </div>
								...
								<?php if (!empty($documents)) : ?>
									<div class="row mt-3">
										<?php foreach ($documents as $doc) : ?>
											...
											<a href="<?= $baseUrl ?>/html/material/view_document.php?file=<?= urlencode($doc['file_path']) ?>"
												   target="_blank"
