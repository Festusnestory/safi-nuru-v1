<?php
/**
 * Seller portfolio listing. Ported from html/material/agentsellers_matched.php
 * (page chrome - always agent_nemu.php sidebar, same as match-table.php) plus
 * html/material/selleragent_table.php (table content, previously only
 * reachable as an include of the former behind a NURU_SELLER_AGENT_INCLUDE
 * guard).
 */
/** @var array $sellers */
/** @var string $baseUrl */
