...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Admin Dashboard - Nuru Admin</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
  ...
  <body>
    ...
    <div id="main-wrapper">
     ...
     <?php require NURU_MATERIAL . '/top-bar.php'; ?>
      ...
      <!-- Page wrapper  -->
      <!-- ============================================================== -->
      <?php define('NURU_ADMIN_DASHBOARD', true); require NURU_MATERIAL . '/dashboard.php'; ?>
      <!-- ============================================================== -->
      <!-- End Page wrapper  -->
      <!-- ============================================================== -->
    </div>
        ...
        const NamibiaMap = {
            ...
            async loadNamibiaMap() {
                try {
                    ...
                    // Load the SVG file
                    const response = await fetch('<?= $baseUrl ?>/html/material/na.svg');
                    if (!response.ok) {
