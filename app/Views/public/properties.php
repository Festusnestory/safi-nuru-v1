...
<main id="main">
  ...
  <form class="property-filters" method="get" action="properties.php">
    ...
    <label><span>Property type</span><select name="type"><option value="">All types</option><?php foreach (PublicProperty::types() as $type): ?><option <?= $filters['type'] === $type ? 'selected' : '' ?>><?= e($type) ?></option><?php endforeach; ?></select></label>
