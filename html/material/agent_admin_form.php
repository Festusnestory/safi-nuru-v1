...
$csrfToken = csrfToken('staff_agent_form');
?>
<!DOCTYPE html>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer border-0 justify-content-center">
            <button type="button" class="btn btn-primary" onclick="window.location.href='agent_list.php'">
      ...
      const AgentForm = {
        ...
        async submitApplication() {
          try {
            ...
            const response = await fetch('admin_agent_processor.php', {
              method: 'POST',
              body: formData
            });
