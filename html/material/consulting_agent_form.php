...
$csrfToken = csrfToken('consulting_agent_form');
?>
<!DOCTYPE html>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form id="consultingAgentForm" novalidate action="admin_consulting_agent_processor.php">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer border-0 justify-content-center">
            <button type="button" class="btn btn-primary" onclick="window.location.href='consultant_list.php'">
