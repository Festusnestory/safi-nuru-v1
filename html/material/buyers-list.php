...
$csrfToken = csrfToken('buyer_management');
?>
<!DOCTYPE html>
  ...
  <body>
    ...
    <div id="main-wrapper">
     ...
     <?php include("top-bar.php"); ?>
      ...
      <!-- Page wrapper  -->
      <!-- ============================================================== -->
		<?php define('NURU_BUYER_LIST_INCLUDE', true); include("buyerlist_table.php"); ?>
      <!-- ============================================================== -->
      <!-- End Page wrapper  -->
      <!-- ============================================================== -->
    </div>
...
document.querySelectorAll('.buyer-approve').forEach(btn => {
    btn.addEventListener('click', function () {
        ...
        fetch('./config/approve_buyer.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-Token': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
