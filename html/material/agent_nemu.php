...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
            <?php if ($__navRole === 'agent_consultant'): ?>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= \App\Core\Router::legacyUrl('dashboard_4.php') ?>" aria-expanded="false">
                ...
                <!-- Log a Consultation -->
                <li class="sidebar-item">
                    <a href="<?= \App\Core\Router::legacyUrl('consulting_agent_form.php') ?>" class="sidebar-link waves-effect waves-dark">
                ...
                <!-- My Consultations -->
                <li class="sidebar-item">
                    <a href="<?= \App\Core\Router::legacyUrl('consultant_list.php') ?>" class="sidebar-link waves-effect waves-dark">
            ...
            <?php else: ?>
                ...
                <!-- Dashboard -->
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= \App\Core\Router::legacyUrl('dashboard_3.php') ?>" aria-expanded="false">
                        <i class="mdi mdi-view-dashboard"></i>
                        <span class="hide-menu">Dashboard</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="<?= \App\Core\Router::legacyUrl('buyer/index.php') ?>" class="sidebar-link">
                                <i class="mdi mdi-account-plus"></i>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item">
                            <a href="<?= \App\Core\Router::legacyUrl('match-table.php') ?>" class="sidebar-link">
                                <i class="mdi mdi-table"></i>
                                <span class="hide-menu">Buyer Match Table</span>
                            </a>
                        </li>
						<li class="sidebar-item">
                            <a href="<?= \App\Core\Router::legacyUrl('agentsellers_matched.php') ?>" class="sidebar-link">
                                <i class="mdi mdi-table"></i>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="<?= \App\Core\Router::legacyUrl('agent-tasks-pending.php') ?>" class="sidebar-link">
                                <i class="mdi mdi-clock-outline"></i>
                                <span class="hide-menu">Pending</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?= \App\Core\Router::legacyUrl('agent_tasks-in-progress.php') ?>" class="sidebar-link">
    ...
    <div class="sidebar-footer">
        ...
        <!-- item-->
        <a href="<?= \App\Core\Router::legacyUrl($__navRole === 'agent_consultant' ? 'dashboard_4.php' : 'dashboard_3.php') ?>" class="link" data-bs-toggle="tooltip" data-bs-placement="top" title="Dashboard">
            <i class="mdi mdi-view-dashboard"></i>
        </a>
        <!-- item-->
