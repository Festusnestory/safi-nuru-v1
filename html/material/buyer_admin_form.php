...
$csrfToken = csrfToken('staff_buyer_form');
?>
<!DOCTYPE html>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <!-- Form -->
                            <form id="buyerApplicationForm" novalidate action="admin_buyer_processor.php">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer border-0 justify-content-center">
            <button type="button" class="btn btn-primary" onclick="window.location.href='buyers-list.php'">
              <i class="fas fa-home me-2"></i>
              View Buyers
            </button>
          </div>
