...
// Agents can work with properties they loaded, properties whose seller is
// assigned to them, and properties attached to one of their seller tasks.
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<span class="badge bg-secondary"><?= ucfirst($p['property_status']) ?></span>
									</td>
									<td><?= renderCountdownBadge($p['property_status'], $p['status_deadline']) ?: '—' ?></td>
