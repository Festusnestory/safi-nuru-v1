...
$csrfToken = csrfToken('staff_seller_form');
?>
<!DOCTYPE html>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer border-0 justify-content-center">
            <button type="button" class="btn btn-primary" onclick="window.location.href='<?= currentRole() === 'agent_coordinator' ? 'dashboard_3.php' : (currentRole() === 'manager' ? 'dashboard_2.php' : 'admin.php') ?>'">
              <i class="fas fa-home me-2"></i>
              Return to Dashboard
            </button>
          </div>
    ...
    const SellerForm = {
        ...
        async submitApplication() {
            try {
                ...
                // Submit to server
                const response = await fetch('seller_admin_processor.php', {
                    method: 'POST',
                    headers: {
