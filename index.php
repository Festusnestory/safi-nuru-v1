...
$featured = publicProperties($pdo, [], 3);
    ...
    <div class="property-grid">
      <?php if ($featured): foreach ($featured as $property): ?>
        <article class="property-card reveal">
          <a href="property.php?id=<?= (int)$property['id'] ?>" class="property-image"><img loading="lazy" src="<?= e(publicPropertyImage($property['primary_image'])) ?>" alt="<?= e($property['image_alt'] ?: $property['property_detail_type'] . ' in ' . $property['property_town']) ?>"><span>View property</span></a>
